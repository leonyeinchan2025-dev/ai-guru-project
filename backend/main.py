...
# 🌟 အသစ်: ရှိပြီးသား Users Table ထဲသို့ last_active ကော်လံ အတင်းထည့်ခိုင်းခြင်း 🌟
try:
    with engine.begin() as conn:
        # IF NOT EXISTS ပါသည့်အတွက် နောက်တစ်ခါ Run လျှင် Error ထပ်မတက်တော့ပါ
        conn.execute(text("ALTER TABLE users ADD COLUMN IF NOT EXISTS last_active TIMESTAMP"))
        print("✅ Database column 'last_active' updated successfully!")
